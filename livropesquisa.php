...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div style="width:700px; margin: 0 auto;">
                ...
                $sql = "SELECT * FROM livro WHERE nome like '%$filtronome%'  order by codigo ";
                ...
                <section>
                    <?php
                    echo '<br>';
                    echo "<h2> Livros encontrados com o termo <strong> '$filtronome' </strong> </h2>";
                    echo '<fieldset>';
    ...
    <div class="row">
        <div class="col-md-12" id="botoes">
            ...
            <!--<a href="livroRelatorio.php"  target="_blank" class="btn btn-primary btn-danger"><i  style="font-size:48px;color:white" class="fa fa-file-pdf-o"></i></a>
